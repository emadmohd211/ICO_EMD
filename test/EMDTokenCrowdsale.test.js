...
const EMDTokenCrowdsale = artifacts.require('EMDTokenCrowdsale');
const RefundVault = artifacts.require('./RefundVault');
const TokenTimelock = artifacts.require('./TokenTimelock');

contract('EMDTokenCrowdsale', function([_, wallet, investor1, investor2, foundersFund, foundationFund, partnersFund]) {
  ...
  beforeEach(async function () {
    ...
    this.crowdsale = await EMDTokenCrowdsale.new(
      this.rate,
      this.wallet,
      this.token.address,
      this.cap,
